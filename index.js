...
async function fetchRemoteProto(nodeAddr) {
    let protoDescriptor = grpc.load('/Users/abilican/Desktop/QRL/qrl/protos/qrl.proto');
    // console.log(protoDescriptor);
    let client = new protoDescriptor.qrl.PublicAPI(nodeAddr, grpc.credentials.createInsecure());

    return new Promise( (resolve) => {
        client.GetStats({}, function (err, nodeInfo) {
            if (err) {
                // TODO: Handle errors
                throw err;
            }
